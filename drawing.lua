local hfyjgtcdjyjcgfhnjkcdytmgd = Instance.new("ScreenGui")
hfyjgtcdjyjcgfhnjkcdytmgd.Name = "Drawing | Xeno"
hfyjgtcdjyjcgfhnjkcdytmgd.IgnoreGuiInset = true
hfyjgtcdjyjcgfhnjkcdytmgd.DisplayOrder = 0x7fffffff
hfyjgtcdjyjcgfhnjkcdytmgd.Parent = game:GetService("CoreGui")

local shtsntrsntysntyrfsntx = 0
local jyjtydgjdytmnydt = {
...
local function ytjdtydjdytjdytmnyntd(fontIndex)
	return jyjtydgjdytmnydt[fontIndex]
end

local function fnrnsysftftjhx(transparency)
	return math.clamp(1 - transparency, 0, 1)
end

local srtjyytsfgjuhnfdrctu = setmetatable({
	Visible = true,
	ZIndex = 0,
	Transparency = 1,
	Color = Color3.new(),
...
function Drawing.createLine()
	local lineObj = ({
		From = Vector2.zero,
		To = Vector2.zero,
		Thickness = 1
	} + srtjyytsfgjuhnfdrctu)

	local lineFrame = Instance.new("Frame")
	lineFrame.Name = shtsntrsntysntyrfsntx
	lineFrame.AnchorPoint = Vector2.new(0.5, 0.5)
	lineFrame.BorderSizePixel = 0

	lineFrame.Parent = hfyjgtcdjyjcgfhnjkcdytmgd
	return setmetatable({Parent = hfyjgtcdjyjcgfhnjkcdytmgd}, {
		__newindex = function(_, index, value)
			...
			elseif index == "Transparency" then
				lineFrame.BackgroundTransparency = fnrnsysftftjhx(value)
...
function Drawing.createText()
	...
	textLabel.Name = shtsntrsntysntyrfsntx
	...
	textLabel.Parent, uiStroke.Parent = hfyjgtcdjyjcgfhnjkcdytmgd, textLabel
	...
	return setmetatable({Parent = hfyjgtcdjyjcgfhnjkcdytmgd}, {
		__newindex = function(_, index, value)
			...
			elseif index == "Font" then
				textLabel.FontFace = ytjdtydjdytjdytmnyntd(math.clamp(value, 0, 3))
			elseif index == "Size" then
				textLabel.TextSize = value
			elseif index == "Position" then
				updateTextPosition()
			elseif index == "Center" then
				textLabel.Position = UDim2.fromOffset((value and workspace.CurrentCamera.ViewportSize / 2 or textObj.Position).X, textObj.Position.Y)
			...
			elseif index == "Transparency" then
				local transparency = fnrnsysftftjhx(value)
...
function Drawing.createCircle()
	...
	circleFrame.Name = shtsntrsntysntyrfsntx
	...
	circleFrame.Parent, uiCorner.Parent, uiStroke.Parent = hfyjgtcdjyjcgfhnjkcdytmgd, circleFrame, circleFrame
	...
	return setmetatable({Parent = hfyjgtcdjyjcgfhnjkcdytmgd}, {
		__newindex = function(_, index, value)
			...
			elseif index == "Filled" then
				circleFrame.BackgroundTransparency = value and fnrnsysftftjhx(circleObj.Transparency) or 1
...
function Drawing.createSquare()
	...
	squareFrame.Name = shtsntrsntysntyrfsntx
	squareFrame.BorderSizePixel = 0

	squareFrame.Parent, uiStroke.Parent = hfyjgtcdjyjcgfhnjkcdytmgd, squareFrame
	...
	return setmetatable({Parent = hfyjgtcdjyjcgfhnjkcdytmgd}, {
		__newindex = function(_, index, value)
			...
			elseif index == "Thickness" then
				uiStroke.Thickness = math.clamp(value, 0.6, 0x7fffffff)
			elseif index == "Filled" then
				squareFrame.BackgroundTransparency = value and fnrnsysftftjhx(squareObj.Transparency) or 1
				uiStroke.Enabled = not value
			elseif index == "Visible" then
...
function Drawing.createImage()
	...
	imageFrame.Name = shtsntrsntysntyrfsntx
	imageFrame.BorderSizePixel = 0
	imageFrame.ScaleType = Enum.ScaleType.Stretch
	imageFrame.BackgroundTransparency = 1

	imageFrame.Parent = hfyjgtcdjyjcgfhnjkcdytmgd
	...
	return setmetatable({Parent = hfyjgtcdjyjcgfhnjkcdytmgd}, {
		__newindex = function(_, index, value)
			...
			elseif index == "Transparency" then
				imageFrame.ImageTransparency = fnrnsysftftjhx(value)
			elseif index == "Color" then
...
function Drawing.createQuad()
	...
	fillFrame.Name = shtsntrsntysntyrfsntx .. "_Fill"
	...
	fillFrame.Parent = hfyjgtcdjyjcgfhnjkcdytmgd
...
function Drawing.createTriangle()
	local triangleObj = ({
		PointA = Vector2.zero,
		PointB = Vector2.zero,
		PointC = Vector2.zero,
...
function Drawing.createFrame()
	...
	return setmetatable({Parent = hfyjgtcdjyjcgfhnjkcdytmgd}, {
		__newindex = function(_, index, value)
			...
			elseif index == "Transparency" then
				frame.BackgroundTransparency = fnrnsysftftjhx(value)
			elseif index == "Visible" then
				frame.Visible = value
			elseif index == "ZIndex" then
				frame.ZIndex = value
...
function Drawing.createScreenGui()
	local screenGuiObj = ({
		IgnoreGuiInset = true,
		DisplayOrder = 0,
		ResetOnSpawn = true,
	...
	screenGui.Name = shtsntrsntysntyrfsntx
	...
	return setmetatable({Parent = game:GetService("CoreGui")}, {
		__newindex = function(_, index, value)
...
function Drawing.createTextButton()
	local buttonObj = ({
		Text = "Button",
		Font = Drawing.Fonts.UI,
		Size = 20,
	...
	button.Name = shtsntrsntysntyrfsntx
	button.Text = buttonObj.Text
	button.FontFace = ytjdtydjdytjdytmnyntd(buttonObj.Font)
	...
	button.BackgroundTransparency = fnrnsysftftjhx(buttonObj.Transparency)
	button.Visible = buttonObj.Visible
	button.ZIndex = buttonObj.ZIndex

	button.Parent = hfyjgtcdjyjcgfhnjkcdytmgd

	local buttonEvents = {}

	return setmetatable({
		Parent = hfyjgtcdjyjcgfhnjkcdytmgd,
		...
		__newindex = function(_, index, value)
			...
			if index == "Text" then
				button.Text = value
			elseif index == "Font" then
				button.FontFace = ytjdtydjdytjdytmnyntd(math.clamp(value, 0, 3))
			elseif index == "Size" then
			...
			elseif index == "Transparency" then
				button.BackgroundTransparency = fnrnsysftftjhx(value)
			elseif index == "Visible" then
...
function Drawing.createTextLabel()
	local labelObj = ({
		Text = "Label",
		Font = Drawing.Fonts.UI,
		Size = 20,
	...
	label.Name = shtsntrsntysntyrfsntx
	label.Text = labelObj.Text
	label.FontFace = ytjdtydjdytjdytmnyntd(labelObj.Font)
	...
	label.BackgroundTransparency = fnrnsysftftjhx(labelObj.Transparency)
	label.Visible = labelObj.Visible
	label.ZIndex = labelObj.ZIndex

	label.Parent = hfyjgtcdjyjcgfhnjkcdytmgd
	...
	return setmetatable({Parent = hfyjgtcdjyjcgfhnjkcdytmgd}, {
		__newindex = function(_, index, value)
			...
			if index == "Text" then
				label.Text = value
			elseif index == "Font" then
				label.FontFace = ytjdtydjdytjdytmnyntd(math.clamp(value, 0, 3))
			elseif index == "Size" then
			...
			elseif index == "Transparency" then
				label.BackgroundTransparency = fnrnsysftftjhx(value)
			elseif index == "Visible" then
				label.Visible = value
			elseif index == "ZIndex" then
				label.ZIndex = value
...
function Drawing.createTextBox()
	local boxObj = ({
		Text = "",
		Font = Drawing.Fonts.UI,
		Size = 20,
	...
	textBox.Name = shtsntrsntysntyrfsntx
	textBox.Text = boxObj.Text
	textBox.FontFace = ytjdtydjdytjdytmnyntd(boxObj.Font)
	...
	textBox.BackgroundTransparency = fnrnsysftftjhx(boxObj.Transparency)
	textBox.Visible = boxObj.Visible
	textBox.ZIndex = boxObj.ZIndex

	textBox.Parent = hfyjgtcdjyjcgfhnjkcdytmgd
	...
	return setmetatable({Parent = hfyjgtcdjyjcgfhnjkcdytmgd}, {
		__newindex = function(_, index, value)
			...
			if index == "Text" then
				textBox.Text = value
			elseif index == "Font" then
				textBox.FontFace = ytjdtydjdytjdytmnyntd(math.clamp(value, 0, 3))
			elseif index == "Size" then
			...
			elseif index == "Transparency" then
				textBox.BackgroundTransparency = fnrnsysftftjhx(value)
			elseif index == "Visible" then
...
function isrenderobj(drawingObj)
	local success, isrenderobj = pcall(function()
		return drawingObj.Parent == hfyjgtcdjyjcgfhnjkcdytmgd
	end)
...
function cleardrawcache()
	for _, drawing in hfyjgtcdjyjcgfhnjkcdytmgd:GetDescendants() do
		drawing:Remove()
	end
end